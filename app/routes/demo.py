...
DEMO_CASES = [
        ...
        "items": [
            {
                "id": 11,
                "name": "100 КБ",
                "description": "Бонусы на баланс",
                "image_url": None,
                "bonus_amount": 100,
                "token_amount": 0,
                "contract_refresh_amount": 0,
                "probability": 45.0,
            ...
            },
            {
                "id": 12,
                "name": "+3 жетона",
                "description": "Жетоны для следующего открытия",
                "image_url": None,
                "bonus_amount": 0,
                "token_amount": 3,
                "contract_refresh_amount": 0,
            ...
            },
            {
                "id": 13,
                "name": "Час игры",
                "description": "Приз выдаст администратор",
                "image_url": None,
                "bonus_amount": 0,
                "token_amount": 0,
                "contract_refresh_amount": 0,
                "probability": 20.0,
                "rarity_label": "Очень редкий",
                "is_active": True,
                "sort_order": 3,
            },
            {
                "id": 14,
                "name": "Ночь в клубе",
                "description": "Главный приз кейса",
                "image_url": None,
                "bonus_amount": 0,
                "token_amount": 0,
                "contract_refresh_amount": 0,
                "probability": 5.0,
                "rarity_label": "Ультра редкий",
                "is_active": True,
                "sort_order": 4,
            },
        ],
    ...
    {
        "id": 2,
        "name": "Cyber Bonus Case",
        "description": "Бонусы и дополнительные жетоны.",
        "image_url": None,
        "badge_label": "Базовый",
        "badge_color": "#3498db",
        "price_tokens": 2,
        ...
        "items": [
            ...
            },
            {
                "id": 22,
                "name": "+5 жетонов",
                "description": "Редкий возврат жетонов",
                "image_url": None,
                "bonus_amount": 0,
                "token_amount": 5,
                "contract_refresh_amount": 0,
...
def _demo_url_for(endpoint: str, **values) -> str:
    ...
    mapping = {
        ...
        "owner.analytics_cohorts": "cohorts",
        "owner.analytics_communications": "communications",
        "owner.analytics_heatmaps": "heatmaps",
        "owner.guest_pulse": "guest-pulse",
        "owner.promotions": "promotions",
        "owner.training": "training",
        "owner.settings": "settings",
        "owner.team": "team",
        "owner.mailing_page": "mailings",
    }
...
def _common(page: str) -> dict:
    return {
        "demo_mode": True,
        "demo_page": page,
        "header_club_name": "DEMO CLUB",
        "header_user_name": "Демо-пользователь",
        "header_user_login": "demo",
    ...
    return [
        {
            ...
            "type": "number",
            "operators": [{"value": "gte", "label": "не меньше"}, {"value": "lte", "label": "не больше"}],
        },
        {
            "key": "has_telegram",
            "label": "Telegram",
            "type": "select",
            "options": [{"value": "1", "label": "подключён"}, {"value": "0", "label": "не подключён"}],
        },
        {
            "key": "avg_check",
            "label": "Среднее пополнение",
            "type": "number",
            "operators": [{"value": "gte", "label": "не меньше"}],
        },
    ]
...
def _message_variables() -> list[dict]:
    return [
        {"key": "first_name", "label": "Имя", "placeholder": "{first_name}"},
        {"key": "club_name", "label": "Клуб", "placeholder": "{club_name}"},
    ]
...
def _dashboard_context() -> dict:
    ...
    stats = {
        ...
        "guests_previous": 398,
        "guests_diff": 39,
        "guests_diff_percent": 9.8,
        "retention_current": 67.4,
        "retention_previous": 62.1,
        "retention_diff": 5.3,
        "avg_check_current": 684,
        "avg_check_previous": 621,
        "avg_check_diff": 63,
        "avg_check_diff_percent": 10.1,
        "csi_percent": 71.6,
        "csi_linked_guests": 313,
        "csi_total_guests": 437,
        "mailing_count": 1152,
        "kpi_sparklines": {
            "guests_path": "M0 45 C20 40 26 12 45 22 S72 52 88 25 S116 8 140 17",
            "retention_path": "M0 40 C20 35 28 45 44 30 S70 12 89 24 S117 40 140 9",
            "avg_check_path": "M0 42 C22 44 30 20 48 30 S73 46 90 19 S116 12 140 21",
        },
        "visit_streak_funnel": [
            {"label": f"{i}+ дней", "short_label": f"{i}+", "count": count, "height": height}
            for i, count, height in [
                (1, 383, 100),
                (2, 228, 72),
                (3, 164, 57),
                (4, 118, 45),
    ...
    all_time = {
        **engagement,
        "scope": "all_time",
        "wheel": {"total_guests": 1842, "involved_guests": 1117, "engagement_percent": 60.6, "returned_guests": 893},
        "cases": {"total_guests": 1842, "involved_guests": 1259, "engagement_percent": 68.3, "returned_guests": 946},
        "missions": {"total_guests": 1842, "involved_guests": 987, "engagement_percent": 53.6, "returned_guests": 741},
    }
    positive = [
        {
            "guest_id": 1,
            "rating": 5,
            "text": "Понравились компьютеры и атмосфера.",
            "short_text": "Понравились компьютеры и атмосфера.",
            "date": "18.09.2026 21:14",
        },
        {
            "guest_id": 2,
            "rating": 4,
            "text": "Добавьте больше напитков без сахара.",
            "short_text": "Добавьте больше напитков без сахара.",
    ...
    negative = [
        {
            "guest_id": 3,
            "rating": 3,
            "text": "Долго ждал свободный компьютер.",
            "short_text": "Долго ждал свободный компьютер.",
            "date": "16.09.2026 20:05",
        }
    ]
    return {
        **_common("dashboard"),
        ...
        "engagement_all_time_data": all_time,
        ...
        "mission_completions_chart": {
            "items": [
                {"mission_id": 1, "name": "Флеш-рояль", "completions": 129, "width": 100},
                {"mission_id": 2, "name": "Кофейный энтузиаст", "completions": 88, "width": 68},
                {"mission_id": 3, "name": "Ночная лига", "completions": 61, "width": 47},
            ],
            "total_completions": 278,
            "period_days": period,
        },
        "first_visit_feedback": {
            "avg_rating": 4.6,
            "avg_rating_display": "4,6",
            "total_responses": 86,
            "positive_count": 64,
            "negative_count": 22,
        ...
        "funnel": [
            {
                ...
                "label": f"{i} визит",
                "count": count,
                "height": round(count / counts[0] * 100),
                "gap_to_next": [40.8, 35.3, 29.3, 27.2, 24.3, 20.7, None][i - 1],
            }
            for i, count in enumerate(counts, 1)
        ],
        "funnel_period_label": "за всё время",
        "metrics": [
            {"label": "Среднее пополнение", "value": "411 ₽", "hint": "По пополнениям за последние 30 дней"},
            {
                "label": "Средняя длина визита",
                "value": "3 ч 29 мин",
                "hint": "Сессии с разрывом до 2 часов склеиваются",
            },
            {"label": "Визитов в месяц", "value": "0.6", "hint": "Среднее число визитов на гостя"},
            {"label": "Ночь / день", "value": "27.8% / 72.2%", "hint": "Доля ночных и дневных визитов"},
            {"label": "Выходные / будни", "value": "32.4% / 67.6%", "hint": "Доля визитов по дням недели"},
        ],
    }
...
def _crm_context(section: str = "cohorts") -> dict:
    ...
    for index in range(1, 31):
        utilization = round(12 + (index * 17) % 72 + (index % 3) * 0.4, 1)
        hours_value = round(utilization * period * 24 / 100, 1)
        pcs.append(
            {
                "uuid": f"demo-pc-{index}",
                "name": f"ПК {index}",
                "display_name": f"ПК {index}",
                "hours": hours_value,
                "hours_display": str(hours_value).replace(".", ","),
                "sessions_count": 10 + index * 2,
                "utilization_percent": utilization,
                "utilization_display": str(utilization).replace(".", ","),
                "level": min(5, max(1, int(utilization // 20 + 1))),
            }
        )
    return {
        **_common(section),
        ...
        "audience": {"total": 4377, "telegram": 3115},
        "heatmap": {
            "hours": hours,
            "grid": grid,
            "utilization_display": "36,8",
            "peak": {"day": "Суббота", "hour": "21:00", "value": 91},
        },
        "pc_heatmap": {
            "pcs": pcs,
            "total_hours_display": "4 910,2",
            "utilization_display": "26,2",
            "peak": max(pcs, key=lambda item: item["utilization_percent"]),
        },
        ...
        "cohorts": [
            {
                "id": 1,
                "name": "3+ визитов ночью",
                "rules_json": {"rules": [{"field": "visits_total", "operator": "gte", "value": 3}]},
            },
            {"id": 2, "name": "Новые гости", "rules_json": {"rules": []}},
        ],
...
def _missions() -> list[dict]:
    ...
    return [
        ...
        },
        {
            "id": 2,
            "name": "Флеш-рояль",
            "display_name": "Флеш-рояль",
            "description": "Посети клуб 5 дней подряд",
            "target_metric": "visit_streak_days",
            "target_value": 5,
            "target": 5,
            "reward_tokens": 10,
            "reward_bonus": 0,
        ...
        },
        {
            ...
            "description": "Посети клуб 4 раза ночью",
            "target_metric": "night_visits",
            "target_value": 4,
            "target": 4,
            "reward_tokens": 5,
            "reward_bonus": 0,
...
def _settings_context(defaults: dict) -> dict:
    ...
    club = {
        ...
        "lg_api_key": "demo-key",
        "secret": "demo-secret",
        "cm_bonus_admin_chat_id": "-1000000000000",
        "instagram_url": "https://instagram.com/demo",
        "youtube_url": "https://youtube.com/@demo",
        "vk_url": "https://vk.com/demo",
        "telegram_channel_url": "https://t.me/demo",
        "yandex_maps_url": "",
        "two_gis_url": "",
    }
    return {
        **_common("settings"),
        ...
        "bonus_editor": editor,
        "club": club,
        "guest_login_url": flask_url_for("demo.guest", _external=True),
        "timezone_choices": [("Europe/Moscow", "Москва (UTC+3)"), ("Asia/Yekaterinburg", "Екатеринбург (UTC+5)")],
        ...
        "templates": [],
        "missions": _missions(),
        "active_cases": DEMO_CASES,
        "contract_feature_settings": {"is_enabled": True},
        "contract_reward_settings": {
            key: {"tokens": value[0], "bonus": value[1]}
            for key, value in {"easy": (1, 50), "medium": (2, 100), "hard": (3, 200)}.items()
        },
        "wheel_settings": {
            "tokens_start_date": datetime.now() - timedelta(days=90),
            "spin_cost": 2,
            "is_enabled": 1,
            "show_only_own_valuable_drops": 0,
        },
        "prizes": [],
        "wheel_active_prob_sum": 100,
        "prize_icon_choices": ["🎮", "🏆", "🥤", "🔥", "💎", "🪙"],
        "game_mode": "cases",
        "cases": DEMO_CASES,
        ...
        "topup_bonus_settings": {
            "is_enabled": 1,
            "rules": [{"amount": 1000, "bonus": 300}],
            "message_template": "Вам начислено {bonus_amount} КБ",
        },
        "welcome_reward_settings": {
            "welcome_reward_enabled": 1,
            "welcome_cm_bonus_amount": 100,
            "welcome_token_amount": 3,
        },
        "topup_bonus_variables": [],
        "topup_bonus_exclude_from_amount": 100000,
        "topup_bonus_max_rule_amount": 99999.99,
        "guest_management_phone": request.args.get("phone", ""),
        "guest_lookup": None,
        "drop_phone": request.args.get("phone", ""),
        "drop_request_key": "demo",
        "drop_page": {"guests": [], "targets": [], "history": [], "total": 0, "show_all": False, "page": 1, "pages": 1},
...
def _mailing_context() -> dict:
    return {
        **_common("mailing"),
        ...
        "message_variables": _message_variables(),
        "crm_segments": [
            {"key": "active", "emoji": "🔥", "title": "Активные", "description": "Недавно были в клубе", "rules": []},
            {
                "key": "risk",
                "emoji": "💤",
                "title": "В зоне риска",
                "description": "Давно не возвращались",
                "rules": [],
            },
        ],
        "segments": [
            {"id": 1, "name": "Ночные гости", "rules_json": {"rules": []}},
            {"id": 2, "name": "VIP", "rules_json": {"rules": []}},
        ],
        "mailings": [],
        "auto_mailings": [],
        "club_timezone_label": "Москва (UTC+3)",
    ...
    return {
        **_common("guest"),
        ...
        "profile_stats": {
            "total_minutes": 8920,
            "total_hours": 148,
            "loyalty_level_placeholder": "Gold",
            "bonus_balance_placeholder": 350,
        },
        ...
        "reward_history": [],
        "streak_info": {"current_streak": 5, "best_streak": 12},
...
def owner_page(page: str):
    ...
    if kind == "dashboard":
        ...
        context = _crm_context(defaults.get("analytics_section", page))
    elif kind == "pulse":
        context = {
            **_common("guest-pulse"),
            "segments": SEGMENTS,
        ...
        context = _mailing_context()
    elif kind == "training":
        context = {**_common("training"), "videos": []}
    else:
        context = _settings_context(defaults)
...
def _team_payload() -> dict:
    ...
    for index, name in enumerate(["Анна Орлова", "Максим Волков", "Илья Соколов", "Мария Лебедева"], 1):
        ...
        visit2, visit3 = round(club_regs * (0.72 - index * 0.04)), round(
            club_regs * (0.72 - index * 0.04) * (0.68 - index * 0.03)
        )
        admins.append(
            {
                "admin_id": index,
                "name": name,
                "work_schedule": "night" if index % 2 == 0 else "day",
                "has_recent_shift": True,
                "is_working": True,
                "club_registrations": club_regs,
                "club_to_module": connected,
                "module_registrations": connected + 4,
                "module_estimated": 0,
                "shift_count": 11 - index,
                "module_conversion": round(connected / club_regs * 100, 1),
                "cohort": club_regs,
                "visit1": club_regs,
                "visit2": visit2,
                "visit3": visit3,
                "conversion12": round(visit2 / club_regs * 100, 1),
                "conversion23": round(visit3 / visit2 * 100, 1),
            }
        )
    return {
        "ok": True,
        "today": today.isoformat(),
        "registration_range": [(today - timedelta(days=29)).isoformat(), today.isoformat()],
        ...
        rows.append(
            {
                ...
                "overall": {"score": round(health * 0.35 + value * 0.4 + engagement * 0.25, 1), "label": "Средний"},
            }
        )
    return rows
...
def owner_api(path: str):
        ...
        return jsonify(
            {
                "ok": True,
                "cases": [
                    {"id": 1, "name": "WALLZ CS2 Case", "color": "#8f5bff"},
                    {"id": 2, "name": "Cyber Bonus Case", "color": "#3fc9f2"},
                ],
                "buckets": [
                    {"label": f"{day:02d}.09", "values": [10 + (day * 7) % 26, 6 + (day * 5) % 18]}
    ...
    if path == "crm-analysis/preview":
        return jsonify({"ok": True, "analysis": _analysis()})
    if path == "crm-auto-campaigns":
        date_from, date_to = _demo_date_range(7)
        campaigns = [
            {
                "code": "guest_return",
                "title": "Возвращение гостя",
                "unique_recipients": 184,
                "returned_count": 51,
                "conversion_percent": 27.7,
                "topped_up_count": 36,
                "topup_amount": 48200,
            },
            {
                ...
                "returned_count": 34,
                "conversion_percent": 35.4,
                "topped_up_count": 21,
                "topup_amount": 26700,
            },
        ]
        return jsonify(
            {"ok": True, "date_from": date_from.isoformat(), "date_to": date_to.isoformat(), "campaigns": campaigns}
        )
    if path.startswith("crm-cohorts"):
    ...
    if path == "guest-pulse":
        ...
        for row in rows[:4]:
            ...
            copy["deviations"] = [
                {
                    "metric": "health",
                    "baseline_30d": row["health"]["score"] + 18,
                    "score": row["health"]["score"],
                    "deviation_points": -18,
                    "deviation_percent": -28.4,
                    "deviation_direction": "DOWN",
                    "deviation_ratio": 0.284,
                    "baseline_estimated": False,
                }
            ]
            deviations.append(copy)
        return jsonify(
            {
                "ok": True,
    ...
    if path.startswith("guest-pulse/guests/"):
        guest_id = int(path.rsplit("/", 1)[-1])
        row = next((item for item in _guest_rows() if item["guest_id"] == guest_id), _guest_rows()[0])
        guest = {
            **row,
            "health": {
                "score": row["health"]["score"],
                ...
                "score_14d_ago": 71,
                "score_30d_ago": 76,
                "reason_text": "Обычно приходит раз в 4 дня. Последний визит был 11 дней назад.",
            },
            "value": {
                ...
                "visits_90d": 12,
                "avg_check_90d": 517,
                "percentiles": {"revenue_90d": 68, "played_hours_90d": 71, "visits_90d": 65, "avg_check_90d": 59},
                "reference_count": 437,
            },
            "engagement": {
                "score": row["engagement"]["score"],
                "missions_completed_30d": 3,
                "contracts_selected_30d": 2,
                "contracts_completed_30d": 1,
                "cb_actions_30d": 9,
                "current_streak": 4,
                "last_cb_activity_at": datetime.now().isoformat(timespec="minutes"),
            },
            "visits": {
                "last_visit_date": (datetime.now() - timedelta(days=11)).isoformat(timespec="minutes"),
                "typical_gap_days": 4.1,
                "visits_total": 38,
            },
            "visit_pattern": {"period": "День", "calendar": "Будни", "night_share": 44.0, "weekend_share": 31.5},
            "games": {
                "favorite_game": "cs2",
                "favorite_game_hours": 219,
                "recent_game_14d": "cs2",
                "recent_game_14d_hours": 31,
                "updated_at": datetime.now().isoformat(timespec="minutes"),
            },
        }
        history = [
            {
                "snapshot_date": (datetime.now() - timedelta(days=i)).date().isoformat(),
                "health_score": 61 + i % 6,
                "value_score": 68,
                "engagement_score": 52 + i % 4,
                "reconstructed": False,
            }
            for i in range(10)
        ]
        return jsonify({"ok": True, "guest": guest, "history": history, "events": []})
    if path.startswith("guest-pulse/selection"):
        return jsonify(
            {
                "ok": True,
                "group": {
                    "key": "demo",
                    "title": "Демо-аудитория",
                    "guest_ids": [1, 2, 3],
                    "guests": _guest_rows()[:3],
                    "total_count": 3,
                },
            }
        )
    if path.startswith("segments/preview"):
        return jsonify({"ok": True, "count": 346, "sample": []})
...
def guest_api(path: str):
    if path == "tokens":
        return jsonify(
            {"ok": True, "tokens": int(session.get("demo_guest_tokens", 24)), "spin_cost": 2, "is_enabled": True}
        )
    if path == "cm-bonuses":
        return jsonify({"ok": True, "balance": int(session.get("demo_guest_bonus", 350))})
    if path == "cm-bonuses/redeem":
        amount = int(session.get("demo_guest_bonus", 350))
        session["demo_guest_bonus"] = 0
...
def _open_case(case_id: int):
    ...
    if balance < price:
        return jsonify({"error": "no_tokens", "tokens_after": balance}), 400
    ...
    balance = balance - price + int(item.get("token_amount") or 0)
    ...
    claim = (
        None
        if item.get("bonus_amount") or item.get("token_amount")
        else {"id": random.randint(1000, 9999), "status": "pending", "status_label": "ожидает выдачи"}
    )
