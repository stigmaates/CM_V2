...
def sample():
    ...
    return {
        ...
        "health": {
            ...
            "scored_guests": 508,
            "distribution": [
                {"code": "healthy", "label": "Healthy", "count": 208, "percent": 41},
                {"code": "stable", "label": "Stable", "count": 163, "percent": 32},
                {"code": "risk", "label": "Risk", "count": 97, "percent": 19},
                {"code": "critical", "label": "Critical", "count": 40, "percent": 8},
            ],
        },
        "retention": {
            "new_guests": {"first": 120, "second": 68, "third": 41, "second_percent": 56.7, "third_percent": 34.2},
            "all_guests": [
                {"visits": 1, "count": 612, "percent": 100},
                {"visits": 2, "count": 381, "percent": 62.3},
                {"visits": 3, "count": 244, "percent": 39.9},
                {"visits": 4, "count": 156, "percent": 25.5},
                {"visits": 5, "count": 93, "percent": 15.2},
            ],
        },
        "crm": {
            "attribution_days": 7,
