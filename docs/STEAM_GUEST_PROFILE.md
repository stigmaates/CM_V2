...
- История Dota 2 использует бесплатный открытый API OpenDota без платного ключа.
  Ответы кешируются, а фоновая проверка ограничена одним запросом в час на гостя.
